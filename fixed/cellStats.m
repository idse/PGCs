...
%             end
        ...
        function plotDistributionComparison(this, options)
            ...
            if options.cumulative
                legend(this.conditions(options.conditionIdx), 'Location','SouthEast','FontSize',fs);
                ylim([0 1.05]);
            else
                legend(this.conditions(options.conditionIdx), 'Location','NorthEast','FontSize',fs);
                %ylim([0 0.3]);
                %ylim([0 1.05]);
            end
